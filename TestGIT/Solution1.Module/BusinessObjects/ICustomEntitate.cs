...
namespace Solution1.Module.BusinessObjects
{
    ...
    public interface ICustomEntitate
    {
    ...
    //[DomainLogic(typeof(ICustomEntitate))]
    //public class ICustomEntitateLogic {
    //    public static string Get_CalculatedProperty(ICustomEntitate instance) {
    //        // A "Get_" method is executed when getting a target property value. The target property should be readonly.
    //        // Use this method to implement calculated properties.
    //        return "";
    //    }
    //    public static void AfterChange_PersistentProperty(ICustomEntitate instance) {
    //        // An "AfterChange_" method is executed after a target property is changed. The target property should not be readonly. 
    //        // Use this method to refresh dependant property values.
    //    }
    //    public static void AfterConstruction(ICustomEntitate instance) {
    //        // The "AfterConstruction" method is executed only once, after an object is created. 
    //        // Use this method to initialize new objects with default property values.
    //    }
    //    public static int SumMethod(ICustomEntitate instance, int val1, int val2) {
    ...
    //     XafTypesInfo.Instance.RegisterEntity("MyDomainComponent", typeof(ICustomEntitate));
